package org.penguinlauncher;

import org.penguinlauncher.utils.Parameters;
...
public final class SystemProperties {
    public static void apply(Parameters params) {
        ...
        if (name != null)
            System.setProperty("org.penguinlauncher.instance.name", name);
        if (iconId != null)
            System.setProperty("org.penguinlauncher.instance.icon.id", iconId);
        if (iconPath != null)
            System.setProperty("org.penguinlauncher.instance.icon.path", iconPath);
        if (windowTitle != null)
            System.setProperty("org.penguinlauncher.window.title", windowTitle);
        if (windowDimensions != null)
            System.setProperty("org.penguinlauncher.window.dimensions", windowDimensions);
