...

    {
      ...
      devShells = forAllSystems (
        ...
        let
          ...
          welcomeMessage = ''
            Welcome to the Penguin Launcher repository! 🌈
          ...
          qt-wrapper-env = packages'.penguinlauncher.overrideAttrs (old: {
            name = "qt-wrapper-env";
...

        {
          default = mkShell {
            ...
            inputsFrom = [ packages'.penguinlauncher-unwrapped ];
            ...
            cmakeFlags = [ "-GNinja" ] ++ packages'.penguinlauncher-unwrapped.cmakeFlags;
            dontFixCmake = true;
      ...
      overlays.default =
        ...
        {
          penguinlauncher-unwrapped = prev.callPackage ./nix/unwrapped.nix {
            inherit (llvm) stdenv;
            inherit
              libnbtplusplus
              self
          ...
          penguinlauncher = final.callPackage ./nix/wrapper.nix { };
        };
      ...
      packages = forAllSystems (
        ...
        let
          ...
          packages = {
            inherit (prismPackages) penguinlauncher-unwrapped penguinlauncher;
            default = prismPackages.penguinlauncher;
          };
        in
      ...
      legacyPackages = forAllSystems (
        ...
        {
          penguinlauncher-debug = packages'.penguinlauncher.override {
            penguinlauncher-unwrapped = legacyPackages'.penguinlauncher-unwrapped-debug;
          };

          penguinlauncher-unwrapped-debug = packages'.penguinlauncher-unwrapped.overrideAttrs {
            cmakeBuildType = "Debug";
            dontStrip = true;
          };
        }
