...
LAUNCHER_APPID="org.penguinlauncher.PenguinLauncher"
...
if command -v "inkscape" && command -v "icotool" && command -v "oxipng"; then
    ...
    svg2png ${LAUNCHER_APPID}.svg "$d/penguinlauncher_16.png" 16 16
    svg2png ${LAUNCHER_APPID}.svg "$d/penguinlauncher_24.png" 24 24
    svg2png ${LAUNCHER_APPID}.svg "$d/penguinlauncher_32.png" 32 32
    svg2png ${LAUNCHER_APPID}.svg "$d/penguinlauncher_48.png" 48 48
    svg2png ${LAUNCHER_APPID}.svg "$d/penguinlauncher_64.png" 64 64
    svg2png ${LAUNCHER_APPID}.svg "$d/penguinlauncher_128.png" 128 128
    svg2png ${LAUNCHER_APPID}.svg "$d/penguinlauncher_256.png" 256 256

    oxipng --opt max --strip all --alpha --interlace 0 "$d/penguinlauncher_"*".png"

    rm penguinlauncher.ico && icotool -o penguinlauncher.ico -c \
        "$d/penguinlauncher_256.png"  \
        "$d/penguinlauncher_128.png"  \
        "$d/penguinlauncher_64.png"   \
        "$d/penguinlauncher_48.png"   \
        "$d/penguinlauncher_32.png"   \
        "$d/penguinlauncher_24.png"   \
        "$d/penguinlauncher_16.png"
else
