...
class Library {
   ...
   private: /* methods */
    /// the default storage prefix used by Penguin Launcher
   ...
   protected: /* data */
    ...
    /// DEPRECATED: Penguin Launcher-specific absolute URL. takes precedence over the implicit maven repo URL, if defined
    QString m_absoluteURL;

    /// Penguin Launcher extension - filename override
    QString m_filename;

    /// DEPRECATED Penguin Launcher extension - display name
    QString m_displayname;

    /**
     * Penguin Launcher-specific type hint - modifies how the library is treated
     */
    QString m_hint;

    /**
     * storage - by default the local libraries folder in Penguin Launcher, but could be elsewhere
     * Penguin Launcher specific, because of FTB.
     */
